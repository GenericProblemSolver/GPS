...
class CharacterData01 extends CharacterData {
    ...
    int getProperties(int ch) {
        char offset = (char) ch;
        int props = A[Y[(X[offset >> 5] << 4) | ((offset >> 1) & 0xF)]
                | (offset & 0x1)];
        return props;
    }
    ...
    // ../../tools/GenerateCharacter/CharacterData01.java.template -spec
    // ../../tools/UnicodeData/UnicodeData.txt -specialcasing
    // ../../tools/UnicodeData/SpecialCasing.txt -o
    // /build/buildd/openjdk-6-6b14-1.4.1/build/openjdk/control/build/linux-i586/gensrc/java/lang/CharacterData01.java
    // -string -usecharforbyte 11 4 1
    // The X table has 2048 entries for a total of 4096 bytes.

    static final char X[] = ("\000\001\002\003\004\004\004\005\006\007\003\003\003\003\003\003\003\003\003"
    ...
    static final char Y[] = ("\000\000\000\000\000\000\002\000\000\000\000\000\000\000\000\000\000\000\000"

 ...
 */
public class Z3JavaApiBackend implements IBytecodeBackend {

    Context ctx;
    public Z3JavaApiBackendMaps mapClass;
    public String logic;

    public Z3JavaApiBackend() {
        this.mapClass = new Z3JavaApiBackendMaps();
        this.logic = "";
    }
            ...
            for (Variable var : problem.problemVariables.keySet()) {
                ...
                solution.variableValues.put(var, mapClass.getResultMap()
                        .getOrDefault(solutionValue.getClass(), (v) -> {
                            ...
                            // the model, since solutionValue.getClass() is still

...
/**
 * Method Implementer for the {@link gps.annotations.Heuristic} annotation.
 *
 * @author haker@uni-bremen.de
 *
 */
public class Heuristic extends AbstractAnnotationImplementer {

    /**
     * Construct the Method Implementer
     */
    public Heuristic() {
        super(gps.annotations.Heuristic.class);
    }

    /**
     * The method that is implemented by this implementer.
     */
    private final static String METHOD_PROTOTYPE = "public java.lang.Number heuristic()";

    /**
     * Method that is implemented by this implementer.
     */
    private final static String METHOD_PROTOTYPE_WITH_PLAYER = "public java.lang.Number heuristic(gps.games.wrapper.Player pPlayer)";

    /**
     * The name of the has-method that this implementer implements.
     */
    private final static String HAS_METHOD_NAME = "hasHeuristicMethod";

    /**
     * The name of the has-method that this implementer implements.
     */
    private final static String HAS_METHOD_WITH_PLAYER_NAME = "hasHeuristicPlayerMethod";
